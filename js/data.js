...
service.client@paypal.com`,
    ...
    // IDs des options clairement inoffensives révélées par Phishing Eye
...

  {
    ...
    options: [
      ...
      },
      {
        ...
        correct: false,
        johnHint: true, // John identifie que c'est très lent comparé aux tables
      },
      {
        id: 'bcrypt_crack',
        ...
        correct: false,
        johnElim: true, // John élimine immédiatement : mauvais algorithme
      },
      {
        id: 'social',
        ...
        correct: false,
        johnElim: true, // Hors scope technique
      },
    ],
    tooltip: {
    ...
    nodes: [
      {
        ...
        vulnerable: false,
        riskLevel: 'LOW',
        riskReason: 'Firmware à jour, SSH par clé, HTTP redirige vers HTTPS.',
      },
      {
        id: 'webserver',
        icon: '🌐',
        ...
        vulnerable: true,
        riskLevel: 'CRITIQUE',
        riskReason: 'MySQL exposé sur internet + Apache EOL non patché.',
      },
      {
        id: 'workstation',
        icon: '💻',
        ...
        vulnerable: false,
        riskLevel: 'MEDIUM',
        riskReason: 'SMB/RDP ouverts mais système entièrement patché.',
      },
      {
        id: 'printer',
        icon: '🖨️',
        ...
        vulnerable: false,
        riskLevel: 'LOW',
        riskReason: 'Admin sans mot de passe mais isolée du réseau principal.',
      },
    ],
